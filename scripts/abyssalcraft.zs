#Enchanted book ritual
  mods.abyssalcraft.InfusionRitual.addRitual("sharpnessRitual",
    ...
    [<evilcraft:invertedPotentia:1>, <abyssalcraft:skin:1>, <botania:overgrowthseed>, <botania:rune:4>, <botania:rune:5>, <botania:rune:6>, <botania:rune:7>], false, ["ench"]);
  ...
  mods.abyssalcraft.InfusionRitual.addRitual("vengeanceUpgrade",
    ...
    [<quark:ancient_tome>.withTag({ench: [{lvl: 3 as short, id: 35 as short}]})), <materialpart:philosophers_gold:ingot>], false, ["ench"]);
