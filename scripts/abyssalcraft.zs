#Enchanted book ritual
  mods.abyssalcraft.InfusionRitual.addRitual("sharpnessRitual",
    ...
    [<evilcraft:invertedPotentia:1>, <bloodmagic:ItemActivationCrystal>, <abyssalcraft:skin:1>, <botania:overgrowthSeed>, <botania:rune:4>, <botania:rune:5>, <botania:rune:6>, <botania:rune:7>], false, ["ench"]);
