# Lists
    ...
    var returns6 = [
        ...
        [<dungeontactics:bronze_sword>,                     <base:nugget:7>],
        [<dungeontactics:copper_sword>,                     <immersiveengineering:metal:20>],
        [<dungeontactics:gilded_sword>,                     <immersiveengineering:metal:29>],
        [<dungeontactics:golden_sword>,                     <minecraft:gold_nugget>],
        [<dungeontactics:iron_sword>,                       <immersiveengineering:metal:29>],
        [<dungeontactics:jewelled_sword>,                   <immersiveengineering:metal:29>],
        [<dungeontactics:lead_sword>,                       <immersiveengineering:metal:22>],
        [<dungeontactics:silver_sword>,                     <immersiveengineering:metal:23>],
        [<dungeontactics:steel_sword>,                      <immersiveengineering:metal:28>],
        [<dungeontactics:tin_sword>,                        <base:nugget:29>],
