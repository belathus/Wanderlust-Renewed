...
# ===============================
  ...
  mods.astralsorcery.StarlightInfusion.addInfusion(<tconstruct:ore:1>,                    <contenttweaker:material_part:11> * 3,     false, 0.05, 200);   # Ardite
  ...
  mods.astralsorcery.StarlightInfusion.addInfusion(<tconstruct:ore>,                      <contenttweaker:material_part:18> * 3,     false, 0.05, 200);   # Cobalt
  ...
  mods.astralsorcery.StarlightInfusion.addInfusion(<contenttweaker:sub_block_holder_2:5>, <contenttweaker:material_part:39> * 3,    false, 0.05, 200);   # Iridium
  ...
  mods.astralsorcery.StarlightInfusion.addInfusion(<thermalfoundation:ore:8>,             <contenttweaker:material_part:46> * 3,    false, 0.05, 200);   # Mithril
  ...
  mods.astralsorcery.StarlightInfusion.addInfusion(<thermalfoundation:ore:6>,             <contenttweaker:material_part:53> * 3,   false, 0.05, 200);   # Platinum
  mods.astralsorcery.StarlightInfusion.addInfusion(<contenttweaker:sub_block_holder_0:6>, <contenttweaker:material_part:60> * 3,  false, 0.05, 200);   # Plutonium
  ...
  mods.astralsorcery.StarlightInfusion.addInfusion(<contenttweaker:sub_block_holder_3:2>, <contenttweaker:material_part:67> * 3,        false, 0.05, 200);   # Tin
  mods.astralsorcery.StarlightInfusion.addInfusion(<contenttweaker:sub_block_holder_3:3>, <contenttweaker:material_part:74> * 3,   false, 0.05, 200);   # Titanium
  ...
  mods.astralsorcery.StarlightInfusion.addInfusion(<contenttweaker:sub_block_holder_0:9>, <contenttweaker:material_part:81> * 3,       false, 0.05, 200);   # Zinc
