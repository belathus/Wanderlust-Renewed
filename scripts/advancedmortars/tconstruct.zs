...
import mods.advancedmortars.Mortar;
  ...
  Mortar.addRecipe(["wood", "stone", "iron", "diamond"], <tconstruct:soil:0> * 4, 6, [
      <ore:clumpLime>, <ore:clumpMud>, <ore:dustAsh>, <biomesoplenty:dirt:2>, <ore:itemBinderComposite>, <minecraft:dye:15>, <primal:terra_clump>, <primal:earthwax_clump>]);
  Mortar.addRecipe(["wood", "stone", "iron", "diamond"], <tconstruct:soil:0> * 4, 6, [
      <ore:clumpLime>, <ore:clumpMud>, <ore:dustAsh>, <biomesoplenty:dirt:2>, <ore:itemBinderComposite>, <minecraft:dye:15>, <primal:cinis_clump>, <primal:earthwax_clump>]);
