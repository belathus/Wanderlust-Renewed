...
#    mods.botania.Orechid.removeOre("*");
    mods.botania.Orechid.addOre(<ore:oreAluminum>,    3);                  # Aluminum Ore
    mods.botania.Orechid.addOre(<ore:oreApatite>,     1);                  # Apatite
    mods.botania.Orechid.addOre(<ore:oreAnthracite>,  2);                  # Anthracite Ore
    mods.botania.Orechid.addOre(<ore:oreBituminous>,  3);                  # Bituminous
    mods.botania.Orechid.addOre(<ore:oreCoal>,        4);                  # Coal Ore
    mods.botania.Orechid.addOre(<ore:oreLignite>,     6);                  # Lignite
    mods.botania.Orechid.addOre(<ore:oreCopper>,      4);                  # Copper Ore
    mods.botania.Orechid.addOre(<ore:oreGold>,        1);                  # Gold Ore
    mods.botania.Orechid.addOre(<ore:oreMagnetitie>,  1);                  # Magnetite
    mods.botania.Orechid.addOre(<ore:oreHematite>,    1);                  # Hematite
    mods.botania.Orechid.addOre(<ore:oreGoethite>,    3);                  # Goethite
    mods.botania.Orechid.addOre(<ore:oreLimonite>,    3);                  # Limonite
    mods.botania.Orechid.addOre(<ore:oreSiderite>,    4);                  # Siderite
    mods.botania.Orechid.addOre(<ore:oreTaconite>,    4);                  # Taconite
    mods.botania.Orechid.addOre(<ore:oreLapis>,       2);                  # Lapis Ore
    mods.botania.Orechid.addOre(<ore:oreLead>,        2);                  # Lead Ore
    mods.botania.Orechid.addOre(<ore:oreRedstone>,    3);                  # Redstone Ore
    mods.botania.Orechid.addOre(<ore:oreSilver>,      2);                  # Silver Ore
    mods.botania.Orechid.addOre(<ore:oreTin>,         2);                  # Tin Ore
    mods.botania.Orechid.addOre(<ore:oreZinc>,        1);                  # Zinc Ore
