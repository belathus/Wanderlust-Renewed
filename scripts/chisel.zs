...
# Slate
  ...
  mods.chisel.Carving.addVariation("limestone", <thebetweenlands:limestone_bricks>);
  mods.chisel.Carving.addVariation("limestone", <thebetweenlands:limestone_tiles>);
  mods.chisel.Carving.addVariation("limestone", <thebetweenlands:mossy_limestone_bricks>);
  mods.chisel.Carving.addVariation("limestone", <thebetweenlands:polished_limestone>);
  mods.chisel.Carving.addVariation("limestone", <thebetweenlands:weak_polished_limestone>);
  mods.chisel.Carving.addVariation("limestone", <thebetweenlands:limestone_pillar>);
  mods.chisel.Carving.addVariation("limestone", <thebetweenlands:limestone_brick_wall>);
  mods.chisel.Carving.addVariation("limestone", <thebetweenlands:limestone_wall>);
  mods.chisel.Carving.addVariation("limestone", <thebetweenlands:polished_limestone_wall>);
