...
*/
  ...
  bonus_tool.addItemEntryHelper(<dungeontactics:iron_hammer>,             160, 0, [tool_dam, tool_ench], []);
  bonus_tool.addItemEntryHelper(<dungeontactics:stone_hammer>,            600, 0, [tool_dam, tool_ench], []);
