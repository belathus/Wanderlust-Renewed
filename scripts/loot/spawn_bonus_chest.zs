...
*/
  ...
  bonus_map.addItemEntryHelper(<minecraft:map>, 1, 0, [Functions.parse({"function": "exploration_map", "destination": "Village", "decoration":"target_point"} as crafttweaker.data.IData)], []);
  
  val bonus_tool = bonus.addPool("tool", 1, 3, 0, 0);
  bonus_tool.addItemEntry(Primal:flint_workblade>,             400, 0);
  bonus_tool.addItemEntry(Primal:flint_shovel>,                400, 0);
  bonus_tool.addItemEntry(Primal:flint_axe>,                   400, 0);
  bonus_tool.addItemEntry(Primal:flint_hatchet>,               400, 0);
  bonus_tool.addItemEntry(Primal:flint_hoe>,                   320, 0);
  bonus_tool.addItemEntry(Primal:flint_pickaxe>,               400, 0);
  bonus_tool.addItemEntry(Primal:flint_saw>,                   400, 0);
  bonus_tool.addItemEntry(Primal:quartz_workblade>,            160, 0);
  bonus_tool.addItemEntry(Primal:quartz_shovel>,               160, 0);
  bonus_tool.addItemEntry(Primal:quartz_axe>,                  160, 0);
  bonus_tool.addItemEntry(Primal:quartz_hatchet>,              160, 0);
  bonus_tool.addItemEntry(Primal:quartz_hoe>,                  120, 0);
  bonus_tool.addItemEntry(Primal:quartz_saw>,                  200, 0);
  bonus_tool.addItemEntry(Primal:quartz_pickaxe>,              160, 0);
  bonus_tool.addItemEntry(Primal:quartz_shears>,               160, 0);
  bonus_tool.addItemEntry(Primal:obsidian_workblade>,           80, 0);
  bonus_tool.addItemEntry(Primal:obsidian_shovel>,              80, 0);
  bonus_tool.addItemEntry(Primal:obsidian_axe>,                 80, 0);
  bonus_tool.addItemEntry(Primal:obsidian_hatchet>,             80, 0);
  bonus_tool.addItemEntry(Primal:obsidian_hoe>,                 60, 0);
  bonus_tool.addItemEntry(Primal:obsidian_pickaxe>,             80, 0);
  bonus_tool.addItemEntry(Primal:copper_saw>,                  240, 0);
  bonus_tool.addItemEntry(Primal:iron_saw>,                    160, 0);
  bonus_tool.addItemEntry(Primal:stone_gallagher>,             600, 0);
  bonus_tool.addItemEntry(Primal:iron_gallagher>,              160, 0);
  bonus_tool.addItemEntry(Primal:nether_gallagher>,            360, 0);
  bonus_tool.addItemEntry(Primal:quartz_gallagher>,            240, 0);
  ...
  val bonus_storage.addPool("storage", 1, 1, 0, 0);
