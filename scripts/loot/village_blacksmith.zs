...
# variables
  ...
  */
  ...
  blacksmith_uncommon.addItemEntryHelper(<dungeontactics:guilded_cutlass>,    20, 0, [tool_dam, tool_ench], []);
  blacksmith_uncommon.addItemEntryHelper(<dungeontactics:guilded_hammer>,     20, 0, [tool_dam, tool_ench], []);
  blacksmith_uncommon.addItemEntryHelper(<dungeontactics:guilded_battleaxe>,  20, 0, [tool_dam, tool_ench], []);
  blacksmith_uncommon.addItemEntryHelper(<dungeontactics:guilded_glaive>,     20, 0, [tool_dam, tool_ench], []);
  blacksmith_uncommon.addItemEntryHelper(<dungeontactics:guilded_knife>,      20, 0, [tool_dam, tool_ench], []);
  blacksmith_uncommon.addItemEntryHelper(<dungeontactics:guilded_cestus>,     20, 0, [tool_dam, tool_ench], []);
  blacksmith_uncommon.addItemEntryHelper(<dungeontactics:guilded_shield>,     20, 0, [tool_dam, tool_ench], []);
  blacksmith_uncommon.addItemEntryHelper(<dungeontactics:guilded_helmet>,     20, 0, [tool_dam, tool_ench], []);
  blacksmith_uncommon.addItemEntryHelper(<dungeontactics:guilded_chestplate>, 20, 0, [tool_dam, tool_ench], []);
  blacksmith_uncommon.addItemEntryHelper(<dungeontactics:guilded_leggings>,   20, 0, [tool_dam, tool_ench], []);
  blacksmith_uncommon.addItemEntryHelper(<dungeontactics:guilded_boots>,      20, 0, [tool_dam, tool_ench], []);
  blacksmith_uncommon.addItemEntryHelper(<dungeontactics:guilded_pickaxe>,    20, 0, [tool_dam, tool_ench], []);
