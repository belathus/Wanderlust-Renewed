...
*/
  ...
  tf_common.addItemEntryHelper(<minecraft:poisonous_pototo>, 30, 0, [Functions.setCount(1, 2)], []);
...
#  tf_ultrarare.addItemEntryHelper(<ebwizardry:spell_book>,                1, 0, [eb_s_advanced], []);
  ...
  tf_basement.addPool("tome", 1, 1, 0, 0).addItemEntryHelper(<quark:ancienttome>, 1, 0, [ancient_tome], [Conditions.randomChance(0.05)]);
