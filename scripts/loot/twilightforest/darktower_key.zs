...
#  val eb_h_master = Functions.parse({"function": "ebwizardry:random_spell", "elements":["healing"], "tiers":["master"]} as crafttweaker.data.IData);
  ...
  val tf_darktower_key = LootTables.getTable("twilightforest:structures/darktower_key/darktower_key");

  #######################################
  ### Twilight Forest: Dark Tower Key ###
  #######################################
/*
    Modify the twilight forest darktower key table to contain...
*/
  tf_darktower_key.clear();

  # Always has a key.
  tf_darktower_key.addPool("key", 1, 1, 0, 0).addItemEntry(<twilightforest:tower_key>, 1, 0);
  ...
  tf_common.addItemEntryHelper(<minecraft:coal>,                   10, 0, [Functions.setCount(1,12)], []);
...
#  tf_common.addItemEntryHelper(<ebwizardry:scroll>,                30, 0, [eb_h_any], []);
  ...
  val tf_uncommon = tf_darktower_key.addPool("uncommon", 2, 4, 0, 0);
...
#  tf_uncommon.addItemEntryHelper(<ebwizardry:spell_book>,               90, 0, [eb_h_apprentice], []);
  ...
  val tf_rare = tf_darktower_key.addPool("rare", 1, 1, 0, 0);
  ...
  val tf_ultrarare = tf_darktower_key.addPool("ultrarare", 1, 1, 0, 0);
...
#  tf_ultrarare.addItemEntryHelper(<ebwizardry:spell_book>,     1, 0, [eb_h_advanced], []);
  ...
  tf_darktower_key.addPool("forestry_bag", 1, 1, 0, 0).addItemEntryHelper(<forestry:adventurer_bag>, 1, 0, [], [Conditions.randomChance(0.05)]);
  tf_darktower_key.addPool("forestry_bee", 1, 1, 0, 0).addItemEntryHelper(<forestry:bee_drone_ge>, 1, 0, [steadfast], [Conditions.randomChance(0.10)]);
  tf_darktower_key.addPool("blood", 1, 1, 0, 0).addItemEntryHelper(<evilcraft:condensed_blood>, 1, 0, [Functions.setCount(1, 32)], [Conditions.randomChance(0.25)]);
  tf_darktower_key.addPool("closure_box", 1, 1, 0, 0).addLootTableEntry("evilcraft:inject/chests/box_of_eternal_closure", 1);
  tf_darktower_key.addPool("overgrowth", 1, 1, 0, 0).addItemEntryHelper(<botania:overgrowthseed>, 1, 0, [], [Conditions.randomChance(0.05)]);
  tf_darktower_key.addPool("lotus", 1, 1, 0, 0).addItemEntryHelper(<botania:blacklotus>, 1, 0, [], [Conditions.randomChance(0.35)]);
  tf_darktower_key.addPool("tome", 1, 1, 0, 0).addItemEntryHelper(<quark:ancient_tome>, 1, 0, [ancient_tome], [Conditions.randomChance(0.05)]);
