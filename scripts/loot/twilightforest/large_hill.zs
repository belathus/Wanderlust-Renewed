...
#  val eb_s_novice = Functions.parse({"function": "ebwizardry:random_spell", "elements":["sorcery"], "tiers":["novice"]} as crafttweaker.data.IData);
...
#  val eb_s_master = Functions.parse({"function": "ebwizardry:random_spell", "elements":["sorcery"], "tiers":["master"]} as crafttweaker.data.IData);
  ...
  ######################################
  ### Twilight Forest: Hollow Hill 3 ###
  ######################################
/*
    Modify the twilight forest large hollow hill table to contain...
*/
  tf_hill_3.clear();

  val tf_common = tf_hill_3.addPool("common", 3, 7, 0, 0);
  ...
  tf_common.addItemEntryHelper(<minecraft:gold_ingot>,       30, 0, [Functions.setCount(1, 2)], []);
  tf_common.addItemEntryHelper(<minecraft:ladder>,           30, 0, [Functions.setCount(1, 6)], []);
  tf_common.addItemEntryHelper(<minecraft:fish>,             30, 0, [Functions.setCount(1, 4)], []);
...
#  tf_common.addItemEntryHelper(<ebwizardry:scroll>,          30, 0, [eb_s_any], []);
  ...
  tf_uncommon.addItemEntryHelper(<twilightforest:liveroot>,    600, 0, [Functions.setCount(1, 6)], []);
  tf_uncommon.addItemEntryHelper(<twilightforest:steeleaf_ingot>, 600, 0, [Functions.setCount(1, 6)], []);
...
#  tf_uncommon.addItemEntryHelper(<ebwizardry:spell_book>,       30, 0, [eb_s_advanced], []);
  ...
  val tf_rare = tf_hill_3.addPool("rare", 1, 1, 0, 0);
  tf_rare.addItemEntryHelper(<minecraft:gold_ingot>,            1, 0, [Functions.setCount(1, 5)], []);
  tf_rare.addItemEntryHelper(<twilightforest:naga_scale>,       2, 0, [Functions.setCount(1, 2)], []);
  tf_rare.addItemEntryHelper(<twilightforest:uncrafting_table>, 2, 0, [], []);
  // tf_rare.addItemEntryHelper(<primal:obsidian_pickaxe>,         1, 0, [tool_ench, tool_dam], []);
  // tf_rare.addItemEntryHelper(<primal:obsidian_shovel>,          1, 0, [tool_ench, tool_dam], []);
  tf_rare.addItemEntry(<ebwizardry:arcane_tome:1>,              1, 0);
  tf_rare.addItemEntry(<ebwizardry:arcane_tome:2>,              1, 0);
  tf_rare.addItemEntryHelper(<twilightforest:transformation_powder>, 2, 0, [Functions.setCount(1, 12)], []);
  ...
  val tf_ultrarare = tf_hill_3.addPool("ultrarare", 1, 1, 0, 0);
  ...
  tf_ultrarare.addItemEntryHelper(<twilightforest:peacock_fan>,          15, 0, [], []);
  tf_ultrarare.addItemEntryHelper(<twilightforest:moonworm_queen>,       15, 0, [], []);
...
#  tf_ultrarare.addItemEntryHelper(<ebwizardry:spell_book>,                1, 0, [eb_s_master], []);
  ...
  tf_hill_3.addPool("forestry_bee", 1, 1, 0, 0).addItemEntryHelper(<forestry:bee_drone_ge>, 1, 0, [steadfast], [Conditions.randomChance(0.10)]);
  tf_hill_3.addPool("blood", 1, 1, 0, 0).addItemEntryHelper(<evilcraft:condensed_blood>, 1, 0, [Functions.setCount(1, 32)], [Conditions.randomChance(0.25)]);
