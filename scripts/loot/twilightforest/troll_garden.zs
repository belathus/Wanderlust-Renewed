...
#  val eb_h_master = Functions.parse({"function": "ebwizardry:random_spell", "elements":["healing"], "tiers":["master"]} as crafttweaker.data.IData);
  ...
  val tf_troll_garden = LootTables.getTable("twilightforest:structures/troll_garden/troll_garden");

  #####################################
  ### Twilight Forest: Troll Garden ###
  #####################################
/*
    Modify the twilight forest troll garden table to contain...
*/
  tf_troll_garden.clear();

  # Always magic beans
  tf_troll_garden.addPool("magic_beans", 1, 1, 0, 0).addItemEntryHelper(<twilightforest:magic_beans>, 1, 0, [], []);

  val tf_common = tf_troll_garden.addPool("common", 3, 7, 0, 0);
  ...
  tf_common.addItemEntryHelper(<minecraft:melon_seeds>,              5, 0, [Functions.setCount(1,12)], []);
...
#  tf_common.addItemEntryHelper(<ebwizardry:scroll>,                 30, 0, [eb_h_any], []);
  ...
  val tf_uncommon = tf_troll_garden.addPool("uncommon", 2, 4, 0, 0);
  tf_common.addItemEntryHelper(<twilightforest:uberous_soil>,           90, 0, [Functions.setCount(1, 8)], []);
...
#  tf_uncommon.addItemEntryHelper(<ebwizardry:spell_book>,                9, 0, [eb_h_apprentice], []);
  ...
  val tf_rare = tf_troll_garden.addPool("rare", 1, 1, 0, 0);
  ...
  val tf_ultrarare = tf_troll_garden.addPool("ultrarare", 1, 1, 0, 0);
...
#  tf_ultrarare.addItemEntryHelper(<ebwizardry:spell_book>,      1, 0, [eb_h_advanced], []);
  ...
  tf_troll_garden.addPool("forestry_bag", 1, 1, 0, 0).addItemEntryHelper(<forestry:adventurer_bag>, 1, 0, [], [Conditions.randomChance(0.05)]);
  tf_troll_garden.addPool("forestry_bee", 1, 1, 0, 0).addItemEntryHelper(<forestry:bee_drone_ge>, 1, 0, [steadfast], [Conditions.randomChance(0.10)]);
  tf_troll_garden.addPool("blood", 1, 1, 0, 0).addItemEntryHelper(<evilcraft:condensed_blood>, 1, 0, [Functions.setCount(1, 32)], [Conditions.randomChance(0.25)]);
  tf_troll_garden.addPool("closure_box", 1, 1, 0, 0).addLootTableEntry("evilcraft:inject/chests/box_of_eternal_closure", 1);
  tf_troll_garden.addPool("overgrowth", 1, 1, 0, 0).addItemEntryHelper(<botania:overgrowthseed>, 1, 0, [], [Conditions.randomChance(0.05)]);
  tf_troll_garden.addPool("lotus", 1, 1, 0, 0).addItemEntryHelper(<botania:blacklotus>, 1, 0, [], [Conditions.randomChance(0.35)]);
  tf_troll_garden.addPool("tome", 1, 1, 0, 0).addItemEntryHelper(<quark:ancient_tome>, 1, 0, [ancient_tome], [Conditions.randomChance(0.05)]);
