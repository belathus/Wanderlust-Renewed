...
*/
  ...
  mt_ultrarare.addItemEntryHelper(<pyrotech:flint_hammer>,  20, 0, [tool_dam, tool_ench], []);
  mt_ultrarare.addItemEntryHelper(<pyrotech:flint_axe>, 20, 0, [tool_dam, tool_ench], []);
  mt_ultrarare.addItemEntryHelper(<pyrotech:flint_hoe>,     20, 0, [tool_dam, tool_ench], []);
  mt_ultrarare.addItemEntryHelper(<pyrotech:flint_sword>,   20, 0, [tool_dam, tool_ench], []);
  mt_ultrarare.addItemEntryHelper(<pyrotech:flint_pickaxe>,    20, 0, [tool_dam, tool_ench], []);
  mt_ultrarare.addItemEntryHelper(<pyrotech:flint_shovel>,   20, 0, [tool_dam, tool_ench], []);
  mt_ultrarare.addItemEntryHelper(<dungeontactics:bone_glaive>,   20, 0, [tool_dam, tool_ench], []);
  mt_ultrarare.addItemEntryHelper(<dungeontactics:bone_hammer>,           20, 0, [tool_dam, tool_ench], []);
  mt_ultrarare.addItemEntryHelper(<ebwizardry:magic_wand>,                 5, 0, [], []);
  mt_ultrarare.addItemEntryHelper(<ebwizardry:novice_earth_wand>,           2, 0, [], []);
  mt_ultrarare.addItemEntryHelper(<ebwizardry:novice_fire_wand>,            2, 0, [], []);
  mt_ultrarare.addItemEntryHelper(<ebwizardry:novice_healing_wand>,         2, 0, [], []);
  mt_ultrarare.addItemEntryHelper(<ebwizardry:novice_ice_wand>,             2, 0, [], []);
  mt_ultrarare.addItemEntryHelper(<ebwizardry:novice_lightning_wand>,       2, 0, [], []);
  mt_ultrarare.addItemEntryHelper(<ebwizardry:novice_necromancy_wand>,      2, 0, [], []);
  mt_ultrarare.addItemEntryHelper(<ebwizardry:novice_sorcery_wand>,         2, 0, [], []);
