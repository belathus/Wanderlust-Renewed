...
*/
  ...
  tools.addItemEntryHelper(<pyrotech:flint_sword>,            20, 0, [], []);
  tools.addItemEntryHelper(<pyrotech:flint_pickaxe>,             20, 0, [], []);
  tools.addItemEntryHelper(<pyrotech:flint_axe>,          20, 0, [], []);
  tools.addItemEntryHelper(<pyrotech:flint_hoe>,              20, 0, [], []);
  tools.addItemEntryHelper(<pyrotech:flint_shovel>,            20, 0, [], []);
