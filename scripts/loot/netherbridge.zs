...
*/
  ...
  mc_ultrarare.addItemEntryHelper(<dungeontactics:golden_hammer>,                   1000, 0, [tool_ench], []);
  ...
  mc_ultrarare.addItemEntry(<ebwizardry:basic_fire_wand>,                            200, 0);
  mc_ultrarare.addItemEntry(<ebwizardry:basic_healing_wand>,                          50, 0);
  mc_ultrarare.addItemEntry(<ebwizardry:basic_ice_wand>,                              50, 0);
  mc_ultrarare.addItemEntry(<ebwizardry:basic_lightning_wand>,                        50, 0);
  mc_ultrarare.addItemEntry(<ebwizardry:basic_necromancy_wand>,                       50, 0);
  mc_ultrarare.addItemEntry(<ebwizardry:basic_sorcery_wand>,                          50, 0);
  ...
  mc_ultrarare.addItemEntryHelper(<dungeontactics:golden_hammer>,                      1, 0, [unbreakable], []);
