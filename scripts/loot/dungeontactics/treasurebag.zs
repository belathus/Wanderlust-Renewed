...
# ==============================
  ...
  dt_tool_pool.addItemEntry(<ebwizardry:novice_earth_wand>, 5, 0);
  dt_tool_pool.addItemEntry(<ebwizardry:novice_fire_wand>, 5, 0);
  dt_tool_pool.addItemEntry(<ebwizardry:novice_healing_wand>, 5, 0);
  dt_tool_pool.addItemEntry(<ebwizardry:novice_ice_wand>, 5, 0);
  dt_tool_pool.addItemEntry(<ebwizardry:novice_lightning_wand>, 5, 0);
  dt_tool_pool.addItemEntry(<ebwizardry:novice_necromancy_wand>, 5, 0);
  dt_tool_pool.addItemEntry(<ebwizardry:novice_sorcery_wand>, 5, 0);
