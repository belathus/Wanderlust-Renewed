...
*/
  ...
  as_ultrarare.addItemEntryHelper(<minecraft:diamond_axe>,                 20, 0, [tool_dam, tool_ench], []);
  as_ultrarare.addItemEntryHelper(<minecraft:diamond_hoe>,                 20, 0, [tool_dam, tool_ench], []);
  as_ultrarare.addItemEntryHelper(<minecraft:diamond_pickaxe>,             40, 0, [tool_dam, tool_ench], []);
  as_ultrarare.addItemEntryHelper(<artisanworktables:artisans_handsaw_diamond>,                 20, 0, [tool_dam, tool_ench], []);
  as_ultrarare.addItemEntryHelper(<appliedenergistics2:nether_quartz_cutting_knife>,           160, 0, [tool_dam, tool_ench], []);
  as_ultrarare.addItemEntryHelper(<appliedenergistics2:nether_quartz_spade>,              160, 0, [tool_dam, tool_ench], []);
  as_ultrarare.addItemEntryHelper(<appliedenergistics2:nether_quartz_axe>,                 160, 0, [tool_dam, tool_ench], []);
  // as_ultrarare.addItemEntryHelper(<primal:quartz_hatchet>,             160, 0, [tool_dam, tool_ench], []);
  as_ultrarare.addItemEntryHelper(<appliedenergistics2:nether_quartz_hoe>,                 120, 0, [tool_dam, tool_ench], []);
  // as_ultrarare.addItemEntryHelper(<primal:quartz_saw>,                 200, 0, [tool_dam, tool_ench], []);
  as_ultrarare.addItemEntryHelper(<appliedenergistics2:nether_quartz_pickaxe>,             320, 0, [tool_dam, tool_ench], []);
  ...
  as_ultrarare.addItemEntryHelper(<artisanworktables:artisans_handsaw_copper>,                 240, 0, [tool_dam, tool_ench], []);
  as_ultrarare.addItemEntryHelper(<artisanworktables:artisans_handsaw_iron>,                   160, 0, [tool_dam, tool_ench], []);
  ...
  as_ultrarare.addItemEntry(<ebwizardry:novice_earth_wand>,             100, 0);
  as_ultrarare.addItemEntry(<ebwizardry:novice_fire_wand>,              100, 0);
  as_ultrarare.addItemEntry(<ebwizardry:novice_healing_wand>,           100, 0);
  as_ultrarare.addItemEntry(<ebwizardry:novice_ice_wand>,               100, 0);
  as_ultrarare.addItemEntry(<ebwizardry:novice_lightning_wand>,         100, 0);
  as_ultrarare.addItemEntry(<ebwizardry:novice_necromancy_wand>,        100, 0);
  as_ultrarare.addItemEntry(<ebwizardry:novice_sorcery_wand>,           100, 0);
