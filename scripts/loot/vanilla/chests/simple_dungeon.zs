...
*/
  ...
  dungeon_tool.addItemEntryHelper(<dungeontactics:steel_helmet>,                   30, 0, [tool_ench], []);
  dungeon_tool.addItemEntryHelper(<dungeontactics:steel_chestplate>,               30, 0, [tool_ench], []);
  dungeon_tool.addItemEntryHelper(<dungeontactics:steel_leggings>,                 30, 0, [tool_ench], []);
  dungeon_tool.addItemEntryHelper(<dungeontactics:steel_boots>,                    30, 0, [tool_ench], []);
