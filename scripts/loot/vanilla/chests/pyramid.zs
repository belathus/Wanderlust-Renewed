...
*/
  ...
  # Dungeon Tactics stuff
    dp_ultrarare.addItemEntryHelper(<dungeontactics:jewelled_helmet>,          30, 0, [tool_ench], []);
    dp_ultrarare.addItemEntryHelper(<dungeontactics:jewelled_chestplate>,      30, 0, [tool_ench], []);
    dp_ultrarare.addItemEntryHelper(<dungeontactics:jewelled_leggings>,        30, 0, [tool_ench], []);
    dp_ultrarare.addItemEntryHelper(<dungeontactics:jewelled_boots>,           30, 0, [tool_ench], []);
