...
*/
  ...
  pyramid_treasure.addItemEntryHelper(<pyramidtactics:magic_tether>,  10, 0, [], []);
  pyramid_treasure.addItemEntryHelper(<pyramidtactics:heart_jar>,     10, 0, [], []);
  ...
  pyramid_mundane.addItemEntry(<pyramidtactics:ducttape>,        3, 0);
  pyramid_mundane.addItemEntry(<pyramidtactics:magic_tether>,    3, 0);
  pyramid_mundane.addItemEntryHelper(<pyramidtactics:heart_jar>, 3, 0, [Functions.setCount(2, 4)], []);
