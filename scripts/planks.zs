...
# Planks List
    var list_logs = [
        ...
        [<biomesoplenty:log_0:7>, <biomesoplenty:planks_0:3>, <biomesoplenty:fir_stairs>, <biomesoplenty:wood_slab_0:3>],
        [<biomesoplenty:log_1:4>, <biomesoplenty:planks_0:4>, <biomesoplenty:ethereal_stairs>, <biomesoplenty:wood_slab_0:4>],
        [<biomesoplenty:log_1:5>, <biomesoplenty:planks_0:5>, <biomesoplenty:magic_stairs>, <biomesoplenty:wood_slab_0:5>],
        [<biomesoplenty:log_1:6>, <biomesoplenty:planks_0:6>, <biomesoplenty:mangrove_stairs>, <biomesoplenty:wood_slab_0:6>],
        [<biomesoplenty:log_1:7>, <biomesoplenty:planks_0:7>, <biomesoplenty:palm_stairs>, <biomesoplenty:wood_slab_0:7>],
        [<biomesoplenty:log_2:4>, <biomesoplenty:planks_0:8>, <biomesoplenty:redwood_stairs>, <biomesoplenty:wood_slab_1:0>],
        [<biomesoplenty:log_2:5>, <biomesoplenty:planks_0:9>, <biomesoplenty:willow_stairs>, <biomesoplenty:wood_slab_1:1>],
        [<biomesoplenty:log_2:6>, <biomesoplenty:planks_0:10>, <biomesoplenty:pine_stairs>, <biomesoplenty:wood_slab_1:2>],
        [<biomesoplenty:log_2:7>, <biomesoplenty:planks_0:11>, <biomesoplenty:hellbark_stairs>, <biomesoplenty:wood_slab_1:3>],
        [<biomesoplenty:log_3:4>, <biomesoplenty:planks_0:12>, <biomesoplenty:jacaranda_stairs>, <biomesoplenty:wood_slab_1:4>],
...
#        [null, <erebus:planks:12>, <erebus:stairs_varnished>, <erebus:slab_planks_varnished>],
        ...
        [<forestry:logs.1:0>, <forestry:planks.0:4>,<forestry:stairs.chestnut>,<forestry:slabs.0:4>],
        [<forestry:logs.1:1>, <forestry:planks.0:5>,<forestry:stairs.wenge>,<forestry:slabs.0:5>],
        [<forestry:logs.1:2>, <forestry:planks.0:6>,<forestry:stairs.baobab>,<forestry:slabs.0:6>],
        [<forestry:logs.1:3>, <forestry:planks.0:7>,<forestry:stairs.sequoia>,<forestry:slabs.0:7>],
        [<forestry:logs.2:0>, <forestry:planks.0:8>,<forestry:stairs.kapok>,<forestry:slabs.1:0>],
        [<forestry:logs.2:1>, <forestry:planks.0:9>,<forestry:stairs.ebony>,<forestry:slabs.1:1>],
        [<forestry:logs.2:2>, <forestry:planks.0:10>,<forestry:stairs.mahogany>,<forestry:slabs.1:2>],
        [<forestry:logs.2:3>, <forestry:planks.0:11>,<forestry:stairs.balsa>,<forestry:slabs.1:3>],
        [<forestry:logs.3:0>, <forestry:planks.0:12>,<forestry:stairs.willow>,<forestry:slabs.1:4>],
        [<forestry:logs.3:1>, <forestry:planks.0:13>,<forestry:stairs.walnut>,<forestry:slabs.1:5>],
        [<forestry:logs.3:2>, <forestry:planks.0:14>,<forestry:stairs.greenheart>,<forestry:slabs.1:6>],
        [<forestry:logs.3:3>, <forestry:planks.0:15>,<forestry:stairs.cherry>,<forestry:slabs.1:7>],
        [<forestry:logs.4:0>, <forestry:planks.1:0>,<forestry:stairs.mahoe>,<forestry:slabs.2:0>],
        [<forestry:logs.4:1>, <forestry:planks.1:1>,<forestry:stairs.poplar>,<forestry:slabs.2:1>],
        [<forestry:logs.4:2>, <forestry:planks.1:2>,<forestry:stairs.palm>,<forestry:slabs.2:2>],
        [<forestry:logs.4:3>, <forestry:planks.1:3>,<forestry:stairs.papaya>,<forestry:slabs.2:3>],
        [<forestry:logs.5:0>, <forestry:planks.1:4>,<forestry:stairs.pine>,<forestry:slabs.2:4>],
        [<forestry:logs.5:1>, <forestry:planks.1:5>,<forestry:stairs.plum>,<forestry:slabs.2:5>],
        [<forestry:logs.5:2>, <forestry:planks.1:6>,<forestry:stairs.maple>,<forestry:slabs.2:6>],
        [<forestry:logs.5:3>, <forestry:planks.1:7>,<forestry:stairs.citrus>,<forestry:slabs.2:7>],
        [<forestry:logs.6:0>, <forestry:planks.1:8>,<forestry:stairs.giganteum>,<forestry:slabs.3:0>],
        [<forestry:logs.6:1>, <forestry:planks.1:9>,<forestry:stairs.ipe>,<forestry:slabs.3:1>],
        [<forestry:logs.6:2>, <forestry:planks.1:10>,<forestry:stairs.padauk>,<forestry:slabs.3:2>],
        [<forestry:logs.6:3>, <forestry:planks.1:11>,<forestry:stairs.cocobolo>,<forestry:slabs.3:3>],
        [<forestry:logs.7:0>, <forestry:planks.1:12>,<forestry:stairs.zebrawood>,<forestry:slabs.3:4>],
        [<forestry:logs.fireproof.0:0>, <forestry:planks.fireproof.0:0>, <forestry:stairs.fireproof.larch>,<forestry:slabs.fireproof.0:0>],
        [<forestry:logs.fireproof.0:1>, <forestry:planks.fireproof.0:1>, <forestry:stairs.fireproof.teak>,<forestry:slabs.fireproof.0:1>],
        [<forestry:logs.fireproof.0:2>, <forestry:planks.fireproof.0:2>, <forestry:stairs.fireproof.acacia>,<forestry:slabs.fireproof.0:2>],
        [<forestry:logs.fireproof.0:3>, <forestry:planks.fireproof.0:3>, <forestry:stairs.fireproof.lime>,<forestry:slabs.fireproof.0:3>],
        [<forestry:logs.fireproof.1:0>, <forestry:planks.fireproof.0:4>, <forestry:stairs.fireproof.chestnut>,<forestry:slabs.fireproof.0:4>],
        [<forestry:logs.fireproof.1:1>, <forestry:planks.fireproof.0:5>, <forestry:stairs.fireproof.wenge>,<forestry:slabs.fireproof.0:5>],
        [<forestry:logs.fireproof.1:2>, <forestry:planks.fireproof.0:6>, <forestry:stairs.fireproof.baobab>,<forestry:slabs.fireproof.0:6>],
        [<forestry:logs.fireproof.1:3>, <forestry:planks.fireproof.0:7>, <forestry:stairs.fireproof.sequoia>,<forestry:slabs.fireproof.0:7>],
        [<forestry:logs.fireproof.2:0>, <forestry:planks.fireproof.0:8>, <forestry:stairs.fireproof.kapok>,<forestry:slabs.fireproof.1:0>],
        [<forestry:logs.fireproof.2:1>, <forestry:planks.fireproof.0:9>, <forestry:stairs.fireproof.ebony>,<forestry:slabs.fireproof.1:1>],
        [<forestry:logs.fireproof.2:2>, <forestry:planks.fireproof.0:10>,<forestry:stairs.fireproof.mahogany>,<forestry:slabs.fireproof.1:2>],
        [<forestry:logs.fireproof.2:3>, <forestry:planks.fireproof.0:11>,<forestry:stairs.fireproof.balsa>,<forestry:slabs.fireproof.1:3>],
        [<forestry:logs.fireproof.3:0>, <forestry:planks.fireproof.0:12>,<forestry:stairs.fireproof.willow>,<forestry:slabs.fireproof.1:4>],
        [<forestry:logs.fireproof.3:1>, <forestry:planks.fireproof.0:13>,<forestry:stairs.fireproof.walnut>,<forestry:slabs.fireproof.1:5>],
        [<forestry:logs.fireproof.3:2>, <forestry:planks.fireproof.0:14>,<forestry:stairs.fireproof.greenheart>,<forestry:slabs.fireproof.1:6>],
        [<forestry:logs.fireproof.3:3>, <forestry:planks.fireproof.0:15>,<forestry:stairs.fireproof.cherry>,<forestry:slabs.fireproof.1:7>],
        [<forestry:logs.fireproof.4:0>, <forestry:planks.fireproof.1:0>, <forestry:stairs.fireproof.mahoe>,<forestry:slabs.fireproof.2:0>],
        [<forestry:logs.fireproof.4:1>, <forestry:planks.fireproof.1:1>, <forestry:stairs.fireproof.poplar>,<forestry:slabs.fireproof.2:1>],
        [<forestry:logs.fireproof.4:2>, <forestry:planks.fireproof.1:2>, <forestry:stairs.fireproof.palm>,<forestry:slabs.fireproof.2:2>],
        [<forestry:logs.fireproof.4:3>, <forestry:planks.fireproof.1:3>, <forestry:stairs.fireproof.papaya>,<forestry:slabs.fireproof.2:3>],
        [<forestry:logs.fireproof.5:0>, <forestry:planks.fireproof.1:4>, <forestry:stairs.fireproof.pine>,<forestry:slabs.fireproof.2:4>],
        [<forestry:logs.fireproof.5:1>, <forestry:planks.fireproof.1:5>, <forestry:stairs.fireproof.plum>,<forestry:slabs.fireproof.2:5>],
        [<forestry:logs.fireproof.5:2>, <forestry:planks.fireproof.1:6>, <forestry:stairs.fireproof.maple>,<forestry:slabs.fireproof.2:6>],
        [<forestry:logs.fireproof.5:3>, <forestry:planks.fireproof.1:7>, <forestry:stairs.fireproof.citrus>,<forestry:slabs.fireproof.2:7>],
        [<forestry:logs.fireproof.6:0>, <forestry:planks.fireproof.1:8>, <forestry:stairs.fireproof.giganteum>,<forestry:slabs.fireproof.3:0>],
...
#        [<natura:overworld_logs:1>, <natura:overworld_planks:1>,<natura:overworld_stairs_silverbell>,<natura:overworld_slab:1>],
#        [<natura:overworld_logs:2>, <natura:overworld_planks:2>,<natura:overworld_stairs_amaranth>,<natura:overworld_slab:2>],
#        [<natura:overworld_logs:3>, <natura:overworld_planks:3>,<natura:overworld_stairs_tiger>,<natura:overworld_slab:3>],
#        [<natura:overworld_logs2:0>, <natura:overworld_planks:4>,<natura:overworld_stairs_willow>,<natura:overworld_slab:4>],
#        [<natura:overworld_logs2:1>, <natura:overworld_planks:5>,<natura:overworld_stairs_eucalyptus>,<natura:overworld_slab2:0>],
#        [<natura:overworld_logs2:2>, <natura:overworld_planks:6>,<natura:overworld_stairs_hopseed>,<natura:overworld_slab2:1>],
...
#        [<abyssalcraft:dreadlog>,       <abyssalcraft:dreadplanks>,         null, null],
        [<naturalpledge:iris_log0:0>,  <naturalpledge:iris_planks>,       null, null],
        [<naturalpledge:iris_log0:1>,  <naturalpledge:iris_planks:1>,     null, null],
        [<naturalpledge:iris_log0:2>,  <naturalpledge:iris_planks:2>,     null, null],
        [<naturalpledge:iris_log0:3>,  <naturalpledge:iris_planks:3>,     null, null],
        [<naturalpledge:iris_log1:0>,  <naturalpledge:iris_planks:4>,     null, null],
        [<naturalpledge:iris_log1:1>,  <naturalpledge:iris_planks:5>,     null, null],
        [<naturalpledge:iris_log1:2>,  <naturalpledge:iris_planks:6>,     null, null],
        [<naturalpledge:iris_log1:3>,  <naturalpledge:iris_planks:7>,     null, null],
        [<naturalpledge:iris_log2:0>,  <naturalpledge:iris_planks:8>,     null, null],
        [<naturalpledge:iris_log2:1>,  <naturalpledge:iris_planks:9>,     null, null],
        [<naturalpledge:iris_log2:2>,  <naturalpledge:iris_planks:10>,    null, null],
        [<naturalpledge:iris_log2:3>,  <naturalpledge:iris_planks:11>,    null, null],
        [<naturalpledge:iris_log3:0>,  <naturalpledge:iris_planks:12>,    null, null],
        [<naturalpledge:iris_log3:1>,  <naturalpledge:iris_planks:13>,    null, null],
        [<naturalpledge:iris_log3:2>,  <naturalpledge:iris_planks:14>,    null, null],
        [<naturalpledge:iris_log3:3>,  <naturalpledge:iris_planks:15>,    null, null],
        [<naturalpledge:alt_log0:0>,   <naturalpledge:alt_planks>,        null, null],
        [<naturalpledge:alt_log0:1>,   <naturalpledge:alt_planks:1>,      null, null],
        [<naturalpledge:alt_log0:2>,   <naturalpledge:alt_planks:2>,      null, null],
        [<naturalpledge:alt_log0:3>,   <naturalpledge:alt_planks:3>,      null, null],
        [<naturalpledge:alt_log1:0>,   <naturalpledge:alt_planks:4>,      null, null],
        [<naturalpledge:alt_log1:1>,   <naturalpledge:alt_planks:5>,      null, null],
...
# For Loop; removes all plank recipes then re-adds them using the above nested array.
    for i, log_pair in list_logs {
        ...
        recipes.addShaped(slab * 2,
            [[<ore:artisansHandsaw>.transformDamage()], [plank]]);
        mods.artisanworktables.builder.RecipeBuilder.get("carpenter")
            .setShapeless([plank])
            .addOutput(slab * 2)
            .addTool(<ore:artisansHandsaw>, 1)
