...
### EnderIO ###
  ...
  <ore:ingotDarkSteel>.setAspects(<aspect:ignis>,<aspect:metallum>*15,<aspect:spiritus>*2,<aspect:tenebrae>*5,<aspect:terra>*2);
  <ore:ingotRedstoneAlloy>.setAspects(<aspect:ignis>,<aspect:ordo>,<aspect:potentia>*10,<aspect:sensus>);
  <ore:ingotConductiveIron>.setAspects(<aspect:metallum>*15,<aspect:potentia>*10);
  <ore:ingotSoularium>.setAspects(<aspect:desiderium>*10,<aspect:metallum>*10,<aspect:perditio>*5,<aspect:spiritus>*5,<aspect:terra>*5);
  <ore:ingotEndSteel>.setAspects(<aspect:ignis>*10,<aspect:metallum>*15,<aspect:spiritus>*5,<aspect:tenebrae>*15,<aspect:terra>*10);
